...
//-----------------------------------------------------------------------------
enum TComputerModel { CM_UNKNOWN = -1, CM_V1 = 0, CM_V2, CM_V2A, CM_V3, CM_MATO, CM_C2717, CM_LAST = CM_C2717 };
...
enum TRaomType { RT_CHTF = 0, RT_KUVI = 1 };
enum TDisplayMode { DM_NORMAL = 1, DM_DOUBLESIZE, DM_TRIPLESIZE, DM_QUADRUPLESIZE, DM_FULLSCREEN = 0 };
